      ...
      <ha-card style="background: ${this._config.card_background};">
        <div class="card-header" style="padding: ${n};">
          ...
          <div class="header-buttons">
            ...
            ${!1!==this._config.show_clear_button&&o.length>0&&!this._searchQuery?R`
